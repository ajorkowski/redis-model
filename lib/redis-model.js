(function() {
  var BaseModel, RedisModel, redis;
  ...
  module.exports.RedisModel = RedisModel = (function() {

    function RedisModel(_type) {
      this._type = _type;
    ...
    RedisModel.prototype.withKey = function(key, cb) {
      ...
      return cb(new BaseModel(this._fields, this._type, key));
    };
    ...
    RedisModel.prototype.newItem = function(cb) {
      ...
      return redis.incr(this._idCount, function() {
        return redis.get(_this._idCount, function(err, id) {
          return cb(new BaseModel(_this._fields, _this._type, id));
        });
      });
    };
  ...
  BaseModel = (function() {
    ...
    function BaseModel(fields, _type, key) {
      var field, _i, _len;
      this._type = _type;
      this.key = key;
    ...
    BaseModel.prototype.unlock = function(cb) {
      if (this._isLocked) {
        redis.hmset(this._key, this._innerObj, function(err, res) {
          return cb();
        });
        this._innerObj = {};
    ...
    getField = function(self, field, cb) {
      ...
      if (self._key != null) {
        if (self._innerObj[field] != null) {
          ...
          return redis.hget([self._key, field], function(err, res) {
            return cb(res);
          });
        }
      } else {
    ...
    setField = function(self, field, value, cb) {
      ...
      if (self._isLocked) {
        ...
        if (value != null) {
          return redis.hset([self._key, field, value], function(err, res) {
            if (cb != null) return cb();
          });
        } else {
          return redis.hdel([self._key, field], function(err, res) {
            if (cb != null) return cb();
          });
        }
      }
