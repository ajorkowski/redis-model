(function() {
  ...
  module.exports = RedisModel = (function() {
    ...
    function RedisModel(_client, namespace, _seperator) {
      ...
      if ((_ref = this._seperator) == null) this._seperator = ':';
    ...
    RedisModel.prototype.addFields = function() {
      ...
      for (_i = 0, _len = names.length; _i < _len; _i++) {
        ...
        if (name === 'key') throw new Error("The 'key' field is reserved");
        if (name === 'namespace') {
    ...
    RedisModel.prototype.sort = function(externalKey, options, cb) {
      var field, sorting, _i, _len, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      var _this = this;
      if (!(options != null) || typeof options === 'function') {
        cb = options;
        options = {};
      }
      if ((_ref = options.getKey) == null) options.getKey = true;
      if ((_ref2 = options.asc) == null) options.asc = true;
      if ((_ref3 = options.alpha) == null) options.alpha = false;
      if ((_ref4 = options.skip) == null) options.skip = 0;
      if ((_ref5 = options.take) == null) options.take = null;
      if ((_ref6 = options.byField) == null) options.byField = null;
      if ((_ref7 = options.by) == null) options.by = null;
      ...
      if (options.alpha) sorting.push('ALPHA');
      if (!options.asc) sorting.push('DESC');
      if (options.getKey) {
        sorting.push('GET');
        sorting.push('#');
      }
      ...
      return this._client.sort(sorting, function(err, res) {
        var count, field, fieldNum, item, items, noFields, _j, _len2;
        if (err != null) return cb(err);
        items = [];
        item = {};
        noFields = _this._fields.length;
        if (options.getKey) noFields++;
        count = 0;
    ...
    RedisModel.prototype.newItem = function(cb) {
      var _this = this;
      if (!(this.namespace != null)) {
        if (cb != null) cb('The namespace of the model is not defined');
        return;
      }
  ...
  BaseModel = (function() {
    ...
    BaseModel.prototype.setAll = function(obj, cb) {
      var field, multi, _i, _j, _len, _len2, _ref, _ref2;
      if (this._isLocked) {
        _ref = this._fields;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          field = _ref[_i];
        ...
        for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
          field = _ref2[_j];
          if (obj[field] != null) {
            multi.hset(this._key, field, obj[field]);
          } else {
            multi.hdel(this._key, field);
          }
        }
